...
/* ─── Animated counter (matches original: framer-motion spring) ─── */
function Counter({
  value,
  prefix = "",
  suffix = "",
...
/* ─── Pixel dots data (from original source) ─── */
const DOTS = [
  { top: "6%", left: "4%", size: 6, color: "#4CAF50", opacity: 0.872 },
  { top: "18%", left: "8%", size: 5, color: "#64B5F6", opacity: 0.844 },
  { top: "30%", left: "2%", size: 6, color: "#42A5F5", opacity: 0.886 },
  { top: "42%", left: "10%", size: 5, color: "#FFD54F", opacity: 0.83 },
  { top: "55%", left: "5%", size: 6, color: "#81C784", opacity: 0.865 },
  { top: "68%", left: "12%", size: 5, color: "#2E7D32", opacity: 0.816 },
  { top: "80%", left: "3%", size: 6, color: "#64B5F6", opacity: 0.879 },
  { top: "90%", left: "9%", size: 5, color: "#FFF176", opacity: 0.837 },
  { top: "14%", left: "18%", size: 4, color: "#4CAF50", opacity: 0.774 },
  { top: "50%", left: "15%", size: 4, color: "#42A5F5", opacity: 0.795 },
  { top: "75%", left: "20%", size: 4, color: "#81C784", opacity: 0.76 },
  { top: "35%", left: "85%", size: 3, color: "#4CAF50", opacity: 0.305 },
...
export default function ConnectCTA() {
  ...
  /* Yesterday's date, matching original */
  const yesterday = (() => {
    const d = new Date();
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden grid grid-cols-1 lg:grid-cols-3">
        ...
        >
          ...
          <div className="mb-7">
            <span className="text-[20px] md:text-[23px] lg:text-[26px] tracking-[0.02em] text-black">
              <span className="font-medium">Live results across</span>
              <br />
              <span className="font-extrabold">2,000+ clients</span>
            </span>
          </div>
      ...
      {/* ── Right panel: CTA with background image ── */}
      <div className="relative flex items-center justify-center px-4 md:px-8 lg:px-14 py-10 md:py-16 overflow-hidden lg:col-span-2">
        ...
        <div className="relative z-10 w-full max-w-[509px]">
          ...
          >
            <div
              className="rounded-[8px] px-8 md:px-10 py-8 md:py-10 flex flex-col items-center text-center"
